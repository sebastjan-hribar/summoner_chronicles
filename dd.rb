...
class SummonerChronicels < Shoes
  ...
  url '/battle',                    :battle
    ...
    button "Roll the dice" do
          ...
          if @arena == "High mountain"
            para "The battle will take place in the High mountain. Dragons will have
                          a chance for a critical strike."
          elsif @arena == "Dark forrest"
            para "The battle will take place in the Dark forrest. Dire wolves will have
                          a chance for a critical strike."
          else
          end
    end
